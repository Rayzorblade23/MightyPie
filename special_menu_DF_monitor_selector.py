...
class MonitorSetupMenu(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        buttons_data = [
            ("", "", lambda: (pyautogui.hotkey('win', 'num1')), "Desk Single"),
            ("", "", lambda: (pyautogui.hotkey('win', 'num2')), "Desk Dual"),
            ("", "", lambda: (pyautogui.hotkey('win', 'num3')), "TV"),
        ]

        # Create and store buttons
        buttons = [
            create_button(self, icon_name, tooltip, click_action, self.icon_size, CONFIG.BUTTON_HEIGHT, text)
